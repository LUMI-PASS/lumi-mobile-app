...
import { PiCalendarBlank, PiCalendarDotDuotone, PiCalendarDots, PiCalendarDuotone, PiCaretDownBold } from 'react-icons/pi';
		...
		>
			<ReactDatePicker
				customInput={
					customInput || (
						<Input
							prefix={<PiCalendarDots className="h-5 w-5 text-gray-500" />}
							suffix={
								<PiCaretDownBold
									className={cn(
