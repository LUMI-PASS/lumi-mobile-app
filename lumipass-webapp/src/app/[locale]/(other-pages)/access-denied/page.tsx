	...
	return (
		<div className="flex grow items-center px-6 xl:px-10">
			<div className="mx-auto text-center">
				...
				<p className="mt-3 text-xs leading-loose text-gray-500 lg:mt-6 lg:text-base lg:leading-loose">
					Our application is available only for <span className='text-slate-700 font-bold'>mobile devices</span>.
					Please, open the app using your mobile device!
				</p>
			</div>
		</div>
	);
