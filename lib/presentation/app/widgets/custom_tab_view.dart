      ...
      child: Stack(
        children: [
          AnimatedPositioned(
            ...
            left: selectedIndex * (MediaQuery.of(context).size.width - 32.w) / widget.segments.length,
            top: 4.h,
            bottom: 4.h,
            width: (MediaQuery.of(context).size.width - 32.w) / widget.segments.length,
            child: Container(
              margin: EdgeInsets.only(left: selectedIndex == 0 ? 4.w : 0.w, right: selectedIndex == 1 ? 4.w : 0.w),
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.circular(12.r),
                boxShadow: [
