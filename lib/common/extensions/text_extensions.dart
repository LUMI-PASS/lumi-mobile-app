...
extension TextStringExtensions on String {
  Text s(double size) => Text(this).s(size.sp);

  Text w(int weight) => Text(this).w(weight);

  Text c(Color color) => Text(this).c(color);

  Text m(int maxLines) => Text(this).m(maxLines);
...
extension TextExtensions on Text {
  ...
  Text s(double size) => copyWith(
        style: (style ?? GoogleFonts.onest()).copyWith(fontSize: size.sp),
      );

  Text c(Color color) => copyWith(
        style: (style ?? GoogleFonts.onest()).copyWith(color: color),
      );
