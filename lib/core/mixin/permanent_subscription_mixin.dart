...
mixin PermanentSubscriptionMixin<S> on ChessCubit<S> {
  ...
  void addPermanentSubscriptions(
      List<StreamSubscription<Object?>> subscriptions) {
    _permanentSubscriptions.addAll(subscriptions);
  }

  Future<void> cleanSubscriptions(
      List<StreamSubscription<Object?>> subscriptions) async {
